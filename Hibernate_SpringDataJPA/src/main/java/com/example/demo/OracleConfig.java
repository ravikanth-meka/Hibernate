...
@EnableJpaRepositories(basePackages="com.example.repo", entityManagerFactoryRef="courseEntityManagerFactory") //, transactionManagerRef="courseTransactionManager")
//@EnableTransactionManagement
public class OracleConfig {

	private static final String[] PACKAGES_TO_SCAN = { "com.example.entities" };
